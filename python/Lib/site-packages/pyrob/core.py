...
@public
def move_left(n=1):
    repeat(n, step_left) if n >= 0 else repeat(-n, step_right)


@log_invocation
@public
def move_right(n=1):
    repeat(n, step_right) if n >= 0 else repeat(-n, step_left)


@log_invocation
@public
def move_up(n=1):
    repeat(n, step_up) if n >= 0 else repeat(-n, step_down)


@log_invocation
@public
def move_down(n=1):
    repeat(n, step_down) if n >= 0 else repeat(-n, step_up)
