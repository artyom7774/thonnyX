...
class Editor(ttk.Frame):
    ...
    def update_title(self):
        variables.variables.CONTENT_TEXT = self.notebook.get_current_editor_content()
    ...
    def _on_text_change(self, event):
        ...
        # print(self.notebook.get_current_editor_content())

        variables.variables.NOTEBOOK = self.notebook
        variables.variables.CONTENT_TEXT = self.notebook.get_current_editor_content()
